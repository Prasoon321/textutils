...
export default function About() {
    ...
    const[btntoggle,newbtntoggle] =useState("Enable Dark Mode")
    ...
    newbtntoggle("Enable light Mode")
...
<button className='btn btn-primary' onClick={togglestyle}>{btntoggle}</button>
    </div>
    </>
  )
}
